...
import { FaHouse, FaMagnifyingGlass, FaCartShopping, FaClockRotateLeft, FaUser } from "react-icons/fa6";
import Home from "./personalarea/Home";
import Scan from "./personalarea/Scan";
import Loader from "../assets/components/Loader";
import Profile from "./personalarea/Profile";
import History from "./personalarea/History";
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            if (response.code === 200) {
                sessionStorage.setItem('store', JSON.stringify({ id: 1, name: 'Cesena Machiavelli', }));
